...
extern const std::string SamplesFile;
extern const std::string R2Lumi;
extern const std::string R3Lumi;
extern const std::string R23Lumi;
...
extern const NamedFunc higgs_window_refit;
...
extern const NamedFunc blind_data;
extern const NamedFunc blind_refit_data;
...
std::tuple<std::vector<NamedFunc>,std::vector<std::string>> create_control_region_selections_and_labels(int category);//std::string label);
