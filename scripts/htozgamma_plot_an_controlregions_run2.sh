...
do
  nohup run/zgamma/plot_an_controlregions.exe all $cat > output/output_TPr2_$cat.txt &
  #nohup run/zgamma/plot_an_lowidmva_controlregion.exe all $cat > output/output_TPr2_idmva_$cat.txt &
done
