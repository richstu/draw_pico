...
#categories=("2016" "2016APV" "2017" "2018" "2022" "2022EE")
#categories=("2016" "2016APV" "2017" "2018" "2022EE")
categories=("2022" "2022EE" "2023" "2023BPix")
#categories=("2023" "2023BPix")
...
do
  nohup run/zgamma/plot_an_controlregions.exe year $cat > output/output_TP_$cat.txt &
done
