...
do
  nohup run/zgamma/plot_an_controlregions.exe all_run3 $cat > output/output_TPr3_$cat.txt &
  $nohup run/zgamma/plot_an_lowidmva_controlregion.exe all_run3 $cat > output/output_TPr3_idmva_$cat.txt &
done
