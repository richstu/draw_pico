...
int main(int argc, char *argv[]) {
  ...
  vector<shared_ptr<Process>> procs = ZgUtilities::ZgSampleLoader().LoadSamples("txt/samples_zgamma_pinnacles.txt","AllMoreTrigsData");
  string plot_names = "_run2";
  string lumi_label = "137.61";
  if(plot_option=="run3"){
    procs       = ZgUtilities::ZgSampleLoader().LoadSamples("txt/samples_zgamma_pinnacles.txt","AllMoreTrigsDataRun3");
    plot_names = "_run3";
    lumi_label = "62.32";
  ...
  */
  ...
  lin_lumi.Title(TitleType::info)
          ...
          .CanvasWidth(1077)
          .CanvasWidth(900)
          //.Stack(StackType::data_norm) //<---STACK TYPE TO NORMALIZE MC TO DATA. MAKE SURE TO ALSO not_hwin and NOT blind_data
          .FileExtensions({"pdf"});
  ...
  */
  ...
  NamedFunc selection = "1"; string labels = "";
